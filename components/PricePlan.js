...
const PricePlan = ({ pricePlan }) => {
    return (
        <div className='pricePlanCard'>
            <div className='pricePlanCard__tilte'>
                {pricePlan.title}
            </div>
            <div className='pricePlanCard__desc'>
                {pricePlan.description}
            </div>
            <div className='pricePlanCard__priceContainer'>
                <p className='ricePlanCard__priceContainer--price'>
                    {pricePlan.price}
                </p>
            </div>
            {
            ...
            <div className='pricePlanCard__host'>
                ...
                <div className='pricePlanCard__host--text'>
                    {pricePlan.hosting}
                </div>
            </div>
