        ...
        <div className="process">
          <div className="process__left">
            <div className="process__card">
              ...
              <div className="process__card--text">
                <h3>Questionnaire</h3>
                <p>
                  Commencez par remplir notre questionnaire détaillé. Cela nous
                  aidera à comprendre vos besoins et à vous orienter vers
                  l&apos;offre la plus adaptée à vos attentes.
                </p>
              </div>
            </div>
          </div>
          <div className="process__right--empty"></div>
          <div className="process__left--empty"></div>
          <div className="process__right">
            <div className="process__card">
              ...
              <div className="process__card--text">
                <h3>Choix de l&apos;offre</h3>
                <p>
                  En fonction de vos réponses, nous vous recommanderons
                  l&apos;offre la plus adaptée à vos besoins. Vous aurez le
                  choix entre différentes options pour satisfaire vos demandes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="process__left">
            <div className="process__card">
              ...
              <div className="process__card--text">
                <h3>Ajustements suivant vos retours</h3>
                <p>
                  Nous sommes ouverts à vos retours et suggestions. Nous ferons
                  des ajustements en fonction de vos commentaires pour assurer
                  que le design final vous satisfait pleinement.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="process__right">
            <div className="process__card">
              ...
              <div className="process__card--text">
                ...
                <p>
                  Une fois que le design est approuvé, nous nous chargeons de
                  déployer votre site. Il sera entièrement fonctionnel et prêt à
