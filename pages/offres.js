        ...
        <div>
            ...
            <section className='offresSection'>
                ...
                <div className='offresSection__Card'>
                    <img src=".\img\imgSite\creation-de-sites-web.png" alt="illustration design" />
                ...
                <div className='offresSection__Card'>
                    ...
                    <img src=".\img\imgSite\prototype.png" alt="illustration création site" />
                </div>
                <div className="line"></div>
                <div className='offresSection__Card'>
                    <img src=".\img\imgSite\serveur.png" alt="illustration hébergement" />
                    <div className='offresSection__Card--Text--right'>
                        <h2>Hébergement</h2>
                ...
                <div className='offresSection__Card'>
                    ...
                    <img src=".\img\imgSite\entretien.png" alt="illustration maintenance" />
                </div>
                <div className="line"></div>
                <div className='offresSection__Card'>
                    <img src=".\img\imgSite\20943456.png" alt="illustration conseils" />
                    <div className='offresSection__Card--Text--right'>
