    ...
    <>
      ...
      <div className="main">
        ...
        <section className="contactFormContainer">
          <h2>
            Contactez-nous par mail, par le formulaire ou répondez directement
            au questionnaire si vous voulez un devis.
          </h2>
        </section>
        <section className="contactFormContainer">
          <form
          ...
          <div className="contactInfo">
            ...
            <p>
              ...
              <span>
                <a href="tel:+33624777746">+1 438 406 5358</a>
              </span>
            </p>
            <p>
              <span>
        ...
        <section className="contactFormContainer__question">
          ...
          <div className="buttonContact buttonFront contactFormContainer__question--link">
            <Link href="https://forms.gle/DoXGPtBHLjyKdhyJA">
              Questionnaire
            </Link>
          </div>
        </section>
